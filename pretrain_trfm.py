...
def parse_arguments():
    ...
    parser.add_argument('--data', '-d', type=str, default='../data/chembl_24.csv', help='train corpus (.csv)')
    parser.add_argument('--train_data', type=str, default='../data/train_24.csv', help='train corpus (.csv)')
    parser.add_argument('--test_data', type=str, default='../data/test_24.csv', help='train corpus (.csv)')
...
def main():
    ...
    train = Seq2seqDataset(pd.read_csv(args.train_data)['canonical_smiles'].values, vocab)
    print(train[1])
    test = Seq2seqDataset(pd.read_csv(args.test_data)['canonical_smiles'].values, vocab)
